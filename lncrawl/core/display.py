...
def description():
    ...
    if ENABLE_BANNER:
        ...
        title = Chars.BOOK + "Welcome to WebNovel4U"
        padding = " " * ((LINE_SIZE - len(title)) // 2)
        print(Fore.YELLOW, padding + title, Fore.RESET)
        desc = "https://github.com/SharavanMudaliar"
...
def epilog():
    ...
    print(
        " " + Chars.LINK,
        Fore.CYAN,
        "https://github.com/SharavanMudaliar",
        Fore.RESET,
    )
...
def url_not_recognized():
    ...
    #       'https://github.com/SharavanMudaliar', Fore.RESET)
